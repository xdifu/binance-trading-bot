...
CAPITAL_PER_LEVEL = 11  # 每个网格的资金(USDT)，增加到11以确保满足最小订单要求(0.02 ZEC > 10 USDT)
...
TRAILING_STOP_LOSS_PERCENT = 5.0  # 追踪止损百分比（以百分数填写，例如5.0表示5%）
...
PROTECTIVE_TREND_LEVEL_REDUCTION = 1.0  # Trend market level reduction factor (1.0 = no reduction, 0.5 = half levels)
