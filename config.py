...
GRID_SPACING = float(os.getenv("GRID_SPACING", "0.3"))  # 网格间距(%)，增大可捕获更大波动，减小可提高交易频次
...
PROFIT_MARGIN_MULTIPLIER = float(os.getenv("PROFIT_MARGIN_MULTIPLIER", "1.5"))  # 利润与手续费比率要求，增大可提高每笔交易利润要求
BUY_SELL_SPREAD = float(os.getenv("BUY_SELL_SPREAD", "0.4"))  # 买卖差价百分比，增大可提高利润但降低成交概率
